function[hx_use,hy_use,ex_use,ey_use,score_use_hxey,score_use_hyex,t_hxey,t_hyex] = SelectSignalByScore(s,p_index,s_hx,s_hy,s_ex,s_ey,score_hxey,score_hyex,t,Timebegin)
...
t_hxey = t(l_hxey)+Timebegin;
t_hyex = t(l_hyex)+Timebegin;
end
