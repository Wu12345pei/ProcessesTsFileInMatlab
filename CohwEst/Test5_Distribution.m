...
eps_norm_xy = normalize(norm_ey - norm_hx*norm(z_xy));
eps_norm_yx = normalize(norm_ex - norm_hy*norm(z_yx));
...
x = -20:0.1:20;
pd_norm_xy = fitdist(eps_norm_xy,'Stable');
pd_norm_yx = fitdist(eps_norm_yx,'Stable');
